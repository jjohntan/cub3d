...
static void download_img(t_game *g)
{
    ...
    g->texture[0].ptr = mlx_xpm_file_to_image(g->mlx, g->info[NO], &i.w, &i.h);
    g->texture[1].ptr = mlx_xpm_file_to_image(g->mlx, g->info[SO], &i.w, &i.h);
    g->texture[2].ptr = mlx_xpm_file_to_image(g->mlx, g->info[EA], &i.w, &i.h);
    g->texture[3].ptr = mlx_xpm_file_to_image(g->mlx, g->info[WE], &i.w, &i.h);
