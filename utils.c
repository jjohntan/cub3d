...
/*   Updated: 2025/02/19 16:36:31by jetan            ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
/**
 * @brief
 * count_players - Counts the number of players in the game map and updates player data.
 * This function iterates through the map to find player positions marked by 'N', 'S', 'E', or 'W'.
 * For each player found, it increments the player count and updates the player's coordinates and angle.
 */
