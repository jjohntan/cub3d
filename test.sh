...
run_command() {
    ...
    run_command "./map/bad/color_missing_floor_rgb.cub"
    run_command "./map/bad/color_none.cub"
    run_command "./map/bad/color_not_number.cub"
    ...
    run_command "./map/bad/invalid_texture.cub"
    run_command "./map/bad/invalid_char_in_map.cub"
    run_command "./map/bad/map_first.cub"
    run_command "./map/bad/map_middle.cub"
    run_command "./map/bad/map_missing.cub"
    run_command "./map/bad/map_only.cub"
    run_command "./map/bad/map_too_small.cub"
    run_command "./map/bad/missing_color_value.cub"
    run_command "./map/bad/missing_info.cub"
    run_command "./map/bad/new_line_map.cub"
    run_command "./map/bad/no_texture_path.cub"
    run_command "./map/bad/player_multiple.cub"
    run_command "./map/bad/player_none.cub"
    run_command "./map/bad/player_at_corner.cub"
    run_command "./map/bad/player_on_edge.cub"
    ...
    run_command "./map/bad/wall_hole_west.cub"
    ...
    run_command "./map/good/cheese_maze.cub"
    run_command "./map/good/creepy.cub"
    run_command "./map/good/dungeon.cub"
    run_command "./map/good/have_space.cub"
    run_command "./map/good/library.cub"
    run_command "./map/good/matrix.cub"
    run_command "./map/good/sad_face.cub"
    run_command "./map/good/square_map.cub"
    run_command "./map/good/subject_map.cub"
    run_command "./map/good/test_map.cub"
    run_command "./map/good/test_map_2.cub"
    run_command "./map/good/test_map_hole.cub"
    run_command "./map/good/test_pos_bottom.cub"
    run_command "./map/good/test_pos_left.cub"
    run_command "./map/good/test_pos_right.cub"
    run_command "./map/good/test_pos_top.cub"
    run_command "./map/good/test_textures.cub"
    run_command "./map/good/test_whitespace.cub"
